...
func main() {
	//buildBuildingField("/Users/thalesfu/Windows/steam/steamapps/common/Crusader Kings II")

	all := building.LoadAllBuildings("/Users/thalesfu/Windows/steam/steamapps/common/Crusader Kings II")
