...
func main() {
	//buildObjectiveField("R:\\Thales\\Game\\SteamLibrary\\steamapps\\common\\Crusader Kings II")

	allObjectives := objectives.LoadAllObjective("R:\\Thales\\Game\\SteamLibrary\\steamapps\\common\\Crusader Kings II")
...
func buildObjectiveField(dir string) {
	modifiers_dir := filepath.Join(dir, "common", "objectives")
	// 读取目录中的所有文件和子目录
