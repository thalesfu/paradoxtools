...
type CultureGroup struct {
	...
	Cultures map[string]*Culture `paradox_type:"map" paradox_map_key_pattern:"(norse|swedish|norwegian|danish|german|lombard|old_frankish|suebi|english|saxon|old_saxon|frisian|dutch|frankish|norman|italian|occitan|roman|dalmatian|outremer|sardinian|basque|castillan|catalan|portuguese|visigothic|arberian|armenian|greek|alan|georgian|assyrian|coptic|crimean_gothic|irish|scottish|pictish|welsh|breton|finnish|ugricbaltic|komi|khanty|samoyed|mordvin|meshchera|lettigallish|lithuanian|prussian|turkish|pecheneg|cuman|khazar|bolghar|avar|karluk|kirghiz|uyghur|mongol|khitan|jurchen|bedouin_arabic|maghreb_arabic|levantine_arabic|egyptian_arabic|andalusian_arabic|russian|ilmenian|severian|volhynian|pommeranian|bohemian|polish|slovieni|croatian|serbian|romanian|bulgarian|bosnian|carantanian|hungarian|persian|sogdian|tocharian|kurdish|afghan|saka|ethiopian|somali|nubian|daju|kanuri|hausa|zaghawa|manden|soninke|songhay|nahuatl|ashkenazi|sephardi|bengali|oriya|assamese|hindustani|gujurati|panjabi|rajput|sindhi|marathi|sinhala|nepali|tamil|telugu|kannada|bodpa|tangut|zhangzhung|sumpa|han|lappish|horse|cat|bear|hedgehog_culture|duck_culture|dog_culture|elephant_culture|dragon_culture|red_panda)" json:"cultures,omitempty"`
}
